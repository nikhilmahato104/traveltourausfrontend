...
//             </p>
//             <div className="call">
//             <p>If you need immediate booking , please contact us directly via call click <a href="tel:+919304260733">📞 Call Now</a></p>
//             </div>
...
// { label: "Australia", value: "Australia" }, // Added Australia
    // Add more countries as needed
  ];

  // Set the current date automatically when the component mounts
  useEffect(() => {
          ...
          <>
            ...
            <form onSubmit={handleFormSubmit}>
              ...
              <input
                type="date"
                name="bookingDate"
                value={formData.bookingDate}  // This now contains today's date
                onChange={handleInputChange}
                required
              />
              <button
